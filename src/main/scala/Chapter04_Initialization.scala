...
object App2 extends helpers.ZIOAppDebug:
  ...
  // makeY.run returned repl.MdocSession$MdocApp$Y@5fea5255
  // Y.layer is a zio.ZLayer
  // main is a zio.ZIO
  // makeY.run creating Y()
  // y: repl.MdocSession$MdocApp$Y@5a9f7a19
  // Y.display
  // main.run complete
...
object App7 extends helpers.ZIOAppDebug:
  ...
  // Truncating for now: 
  // repl.MdocSession$MdocApp$BreadStoreBought@5841c7da
  // Result: repl.MdocSession$MdocApp$BreadStoreBought@5841

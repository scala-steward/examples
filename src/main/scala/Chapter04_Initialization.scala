...
object App2 extends helpers.ZIOAppDebug:
  ...
  // makeY.run returned repl.MdocSession$MdocApp$Y@8500b7a
  // Y.layer is a zio.ZLayer
  // main is a zio.ZIO
  // makeY.run creating Y()
  // y: repl.MdocSession$MdocApp$Y@44d48d56
  // Y.display
  // main.run complete
...
object App7 extends helpers.ZIOAppDebug:
  ...
  // Truncating for now: 
  // repl.MdocSession$MdocApp$BreadStoreBought@6a616bdb
  // Result: repl.MdocSession$MdocApp$BreadStoreBought@6a61

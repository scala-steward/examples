...
object App4 extends helpers.ZIOAppDebug:
  ...
  // Current requests: List(48, 52)
  // Current requests: List(33, 48, 52)
  // Current requests: List(71, 33, 48, 52)
...
object App5 extends helpers.ZIOAppDebug:
  ...
  // Current requests: List(989, 530)
  // Current requests: List(577, 989, 530)
  // Current requests: List(463, 989, 530)
  // Current requests: List(454, 463, 530)
  // Current requests: List(403, 454, 463)
  // Current requests: List(194, 403)
  // Current requests: List(724, 194, 403)
  // Current requests: List(934, 724, 194)
  // Current requests: List(789, 934)

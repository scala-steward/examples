...
object App5 extends helpers.ZIOAppDebug:
  ...
  // Current requests: List(775, 927)
  // Current requests: List(622, 775, 927)
  // Current requests: List(768, 622, 775, 927)
...
object App6 extends helpers.ZIOAppDebug:
  ...
  // Current requests: List(523, 529)
  // Current requests: List(568, 523, 529)
  // Current requests: List(988, 568, 523)
  // Current requests: List(104, 988)
  // Current requests: List(779, 104, 988)
  // Current requests: List(982, 779, 104)
  // Current requests: List(837, 982, 779)
  // Current requests: List(525, 837, 982)
  // Current requests: List(716, 525)
